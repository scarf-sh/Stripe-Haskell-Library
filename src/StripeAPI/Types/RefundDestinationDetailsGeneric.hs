...
data RefundDestinationDetailsGeneric = RefundDestinationDetailsGeneric {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON RefundDestinationDetailsGeneric
...
instance Data.Aeson.Types.FromJSON.FromJSON RefundDestinationDetailsGeneric
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "RefundDestinationDetailsGeneric" (\obj -> (GHC.Base.pure RefundDestinationDetailsGeneric GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference_status"))}
...
mkRefundDestinationDetailsGeneric = RefundDestinationDetailsGeneric{refundDestinationDetailsGenericReference = GHC.Maybe.Nothing,
