...
instance Data.Aeson.Types.FromJSON.FromJSON LinkedAccountOptionsUsBankAccount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "LinkedAccountOptionsUsBankAccount" (\obj -> ((GHC.Base.pure LinkedAccountOptionsUsBankAccount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "permissions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "prefetch")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "return_url"))}
...
data LinkedAccountOptionsUsBankAccountPrefetch'NonNullable =
   LinkedAccountOptionsUsBankAccountPrefetch'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | LinkedAccountOptionsUsBankAccountPrefetch'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | LinkedAccountOptionsUsBankAccountPrefetch'NonNullableEnumBalances -- ^ Represents the JSON value @"balances"@
  | LinkedAccountOptionsUsBankAccountPrefetch'NonNullableEnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LinkedAccountOptionsUsBankAccountPrefetch'NonNullable
    where {toJSON (LinkedAccountOptionsUsBankAccountPrefetch'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON LinkedAccountOptionsUsBankAccountPrefetch'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> LinkedAccountOptionsUsBankAccountPrefetch'NonNullableEnumBalances
