...
instance Data.Aeson.Types.ToJSON.ToJSON ConnectEmbeddedPaymentsFeatures
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["capture_payments" Data.Aeson.Types.ToJSON..= connectEmbeddedPaymentsFeaturesCapturePayments obj] : ["dispute_management" Data.Aeson.Types.ToJSON..= connectEmbeddedPaymentsFeaturesDisputeManagement obj] : ["refund_management" Data.Aeson.Types.ToJSON..= connectEmbeddedPaymentsFeaturesRefundManagement obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON ConnectEmbeddedPaymentsFeatures
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ConnectEmbeddedPaymentsFeatures" (\obj -> ((GHC.Base.pure ConnectEmbeddedPaymentsFeatures GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "capture_payments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "dispute_management")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "refund_management"))}
...
mkConnectEmbeddedPaymentsFeatures connectEmbeddedPaymentsFeaturesCapturePayments connectEmbeddedPaymentsFeaturesDisputeManagement connectEmbeddedPaymentsFeaturesRefundManagement = ConnectEmbeddedPaymentsFeatures{connectEmbeddedPaymentsFeaturesCapturePayments = connectEmbeddedPaymentsFeaturesCapturePayments,
