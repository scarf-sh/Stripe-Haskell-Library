...
instance Data.Aeson.Types.ToJSON.ToJSON DisputePaymentMethodDetails
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card" Data.Aeson.Types.ToJSON..=)) (disputePaymentMethodDetailsCard obj) : ["type" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "card"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputePaymentMethodDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputePaymentMethodDetails" (\obj -> GHC.Base.pure DisputePaymentMethodDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card"))}
...
data DisputePaymentMethodDetailsCard'NonNullable = DisputePaymentMethodDetailsCard'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputePaymentMethodDetailsCard'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputePaymentMethodDetailsCard'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputePaymentMethodDetailsCard'NonNullable" (\obj -> (GHC.Base.pure DisputePaymentMethodDetailsCard'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "brand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network_reason_code"))}
...
mkDisputePaymentMethodDetailsCard'NonNullable = DisputePaymentMethodDetailsCard'NonNullable{disputePaymentMethodDetailsCard'NonNullableBrand = GHC.Maybe.Nothing,
