...
mkItem :: GHC.Types.Int -- ^ 'itemAmountDiscount'
  ...
  -> Item
mkItem itemAmountDiscount itemAmountSubtotal itemAmountTax itemAmountTotal itemCurrency itemDescription itemId = Item{itemAmountDiscount = itemAmountDiscount,
