...
data InvoiceTaxAmountTaxabilityReason'NonNullable =
   InvoiceTaxAmountTaxabilityReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoiceTaxAmountTaxabilityReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumCustomerExempt -- ^ Represents the JSON value @"customer_exempt"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumNotCollecting -- ^ Represents the JSON value @"not_collecting"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumNotSubjectToTax -- ^ Represents the JSON value @"not_subject_to_tax"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumNotSupported -- ^ Represents the JSON value @"not_supported"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumPortionProductExempt -- ^ Represents the JSON value @"portion_product_exempt"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumPortionReducedRated -- ^ Represents the JSON value @"portion_reduced_rated"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumPortionStandardRated -- ^ Represents the JSON value @"portion_standard_rated"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumProductExempt -- ^ Represents the JSON value @"product_exempt"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumProductExemptHoliday -- ^ Represents the JSON value @"product_exempt_holiday"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumProportionallyRated -- ^ Represents the JSON value @"proportionally_rated"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumReducedRated -- ^ Represents the JSON value @"reduced_rated"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumReverseCharge -- ^ Represents the JSON value @"reverse_charge"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumStandardRated -- ^ Represents the JSON value @"standard_rated"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumTaxableBasisReduced -- ^ Represents the JSON value @"taxable_basis_reduced"@
  | InvoiceTaxAmountTaxabilityReason'NonNullableEnumZeroRated -- ^ Represents the JSON value @"zero_rated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceTaxAmountTaxabilityReason'NonNullable
    where {toJSON (InvoiceTaxAmountTaxabilityReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceTaxAmountTaxabilityReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_exempt" -> InvoiceTaxAmountTaxabilityReason'NonNullableEnumCustomerExempt
