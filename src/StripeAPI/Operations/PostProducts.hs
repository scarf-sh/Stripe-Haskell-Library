...
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsRequestBodyDefaultPriceData'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsRequestBodyDefaultPriceData'" (\obj -> (((((GHC.Base.pure PostProductsRequestBodyDefaultPriceData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal"))}
...
data PostProductsRequestBodyFeatures' = PostProductsRequestBodyFeatures' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsRequestBodyFeatures'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsRequestBodyFeatures'Name obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsRequestBodyFeatures'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsRequestBodyFeatures'" (\obj -> GHC.Base.pure PostProductsRequestBodyFeatures' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name"))}
-- | Create a new 'PostProductsRequestBodyFeatures'' with all required fields.
mkPostProductsRequestBodyFeatures' :: Data.Text.Internal.Text -- ^ 'postProductsRequestBodyFeatures'Name'
