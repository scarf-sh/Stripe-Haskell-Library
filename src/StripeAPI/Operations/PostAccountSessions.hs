...
postAccountSessions body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountSessionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountSessionsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                            AccountSession)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountSessionsResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                              Error)
...
mkPostAccountSessionsRequestBodyComponents' = PostAccountSessionsRequestBodyComponents'{postAccountSessionsRequestBodyComponents'AccountOnboarding = GHC.Maybe.Nothing,
...
mkPostAccountSessionsRequestBodyComponents'Payouts'Features' = PostAccountSessionsRequestBodyComponents'Payouts'Features'{postAccountSessionsRequestBodyComponents'Payouts'Features'EditPayoutSchedule = GHC.Maybe.Nothing,
