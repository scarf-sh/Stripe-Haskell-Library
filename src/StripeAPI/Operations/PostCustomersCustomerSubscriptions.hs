...
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'" (\obj -> GHC.Base.pure PostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "issuer"))}
...
mkPostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings' = PostCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'{postCustomersCustomerSubscriptionsRequestBodyInvoiceSettings'Issuer = GHC.Maybe.Nothing}
