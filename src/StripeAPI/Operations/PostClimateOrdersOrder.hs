...
postClimateOrdersOrder order
                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostClimateOrdersOrderResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostClimateOrdersOrderResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                     Climate'order)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostClimateOrdersOrderResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                       Error)
...
data PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1 = PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["public_name" Data.Aeson.Types.ToJSON..= postClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1" (\obj -> GHC.Base.pure PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "public_name"))}
-- | Create a new 'PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1' with all required fields.
mkPostClimateOrdersOrderRequestBodyBeneficiary'OneOf1 :: PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Variants -- ^ 'postClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'
...
data PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Variants =
   PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString -- ^ Represents the JSON value @""@
  | PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Variants
    where {toJSON (PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString
...
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateOrdersOrderRequestBodyBeneficiary'Variants
    where {toJSON (PostClimateOrdersOrderRequestBodyBeneficiary'PostClimateOrdersOrderRequestBodyBeneficiary'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
