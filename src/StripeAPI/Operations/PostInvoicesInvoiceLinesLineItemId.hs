...
postInvoicesInvoiceLinesLineItemId parameters
                                   body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostInvoicesInvoiceLinesLineItemIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostInvoicesInvoiceLinesLineItemIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         LineItem)
                                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostInvoicesInvoiceLinesLineItemIdResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                           Error)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoicesInvoiceLinesLineItemIdRequestBodyDiscounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostInvoicesInvoiceLinesLineItemIdRequestBodyDiscounts'OneOf1" (\obj -> (GHC.Base.pure PostInvoicesInvoiceLinesLineItemIdRequestBodyDiscounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount"))}
...
instance Data.Aeson.Types.ToJSON.ToJSON PostInvoicesInvoiceLinesLineItemIdRequestBodyTaxAmounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postInvoicesInvoiceLinesLineItemIdRequestBodyTaxAmounts'OneOf1Amount obj] : ["tax_rate_data" Data.Aeson.Types.ToJSON..= postInvoicesInvoiceLinesLineItemIdRequestBodyTaxAmounts'OneOf1TaxRateData obj] : ["taxable_amount" Data.Aeson.Types.ToJSON..= postInvoicesInvoiceLinesLineItemIdRequestBodyTaxAmounts'OneOf1TaxableAmount obj] : GHC.Base.mempty));
