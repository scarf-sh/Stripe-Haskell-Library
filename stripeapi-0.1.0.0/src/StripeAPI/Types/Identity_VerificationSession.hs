...
mkIdentity'verificationSession identity'verificationSessionCreated identity'verificationSessionId identity'verificationSessionLivemode identity'verificationSessionMetadata identity'verificationSessionStatus = Identity'verificationSession{identity'verificationSessionClientSecret = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON Identity'verificationSessionOptions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Identity'verificationSessionOptions'NonNullable" (\obj -> (GHC.Base.pure Identity'verificationSessionOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "document")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id_number"))}
...
data Identity'verificationSessionType'NonNullable =
   Identity'verificationSessionType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Identity'verificationSessionType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Identity'verificationSessionType'NonNullableEnumDocument -- ^ Represents the JSON value @"document"@
  | Identity'verificationSessionType'NonNullableEnumIdNumber -- ^ Represents the JSON value @"id_number"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Identity'verificationSessionType'NonNullable
    where {toJSON (Identity'verificationSessionType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Identity'verificationSessionType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "document" -> Identity'verificationSessionType'NonNullableEnumDocument
