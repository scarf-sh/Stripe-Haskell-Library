...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionCustomFieldsDropdown
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["options" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionCustomFieldsDropdownOptions obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("value" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionCustomFieldsDropdownValue obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionCustomFieldsDropdown
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionCustomFieldsDropdown" (\obj -> (GHC.Base.pure PaymentPagesCheckoutSessionCustomFieldsDropdown GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "value"))}
...
mkPaymentPagesCheckoutSessionCustomFieldsDropdown paymentPagesCheckoutSessionCustomFieldsDropdownOptions = PaymentPagesCheckoutSessionCustomFieldsDropdown{paymentPagesCheckoutSessionCustomFieldsDropdownOptions = paymentPagesCheckoutSessionCustomFieldsDropdownOptions,
