...
data InvoicesInvoiceRendering = InvoicesInvoiceRendering {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesInvoiceRendering
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesInvoiceRendering
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesInvoiceRendering" (\obj -> (GHC.Base.pure InvoicesInvoiceRendering GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pdf"))}
-- | Create a new 'InvoicesInvoiceRendering' with all required fields.
mkInvoicesInvoiceRendering :: InvoicesInvoiceRendering
mkInvoicesInvoiceRendering = InvoicesInvoiceRendering{invoicesInvoiceRenderingAmountTaxDisplay = GHC.Maybe.Nothing,
...
data InvoicesInvoiceRenderingPdf'NonNullable = InvoicesInvoiceRenderingPdf'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesInvoiceRenderingPdf'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("page_size" Data.Aeson.Types.ToJSON..=)) (invoicesInvoiceRenderingPdf'NonNullablePageSize obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesInvoiceRenderingPdf'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesInvoiceRenderingPdf'NonNullable" (\obj -> GHC.Base.pure InvoicesInvoiceRenderingPdf'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "page_size"))}
...
data InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullable =
   InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableEnumA4 -- ^ Represents the JSON value @"a4"@
  | InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableEnumAuto -- ^ Represents the JSON value @"auto"@
  | InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableEnumLetter -- ^ Represents the JSON value @"letter"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullable
    where {toJSON (InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "a4" -> InvoicesInvoiceRenderingPdf'NonNullablePageSize'NonNullableEnumA4
