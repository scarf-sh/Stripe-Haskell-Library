...
instance Data.Aeson.Types.FromJSON.FromJSON DisputePaymentMethodDetailsCard
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputePaymentMethodDetailsCard" (\obj -> (GHC.Base.pure DisputePaymentMethodDetailsCard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "brand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network_reason_code"))}
...
mkDisputePaymentMethodDetailsCard disputePaymentMethodDetailsCardBrand = DisputePaymentMethodDetailsCard{disputePaymentMethodDetailsCardBrand = disputePaymentMethodDetailsCardBrand,
