...
data TreasuryFinancialAccountsResourceAchToggleSettings = TreasuryFinancialAccountsResourceAchToggleSettings {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryFinancialAccountsResourceAchToggleSettings
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["requested" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAchToggleSettingsRequested obj] : ["status" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAchToggleSettingsStatus obj] : ["status_details" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAchToggleSettingsStatusDetails obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryFinancialAccountsResourceAchToggleSettings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryFinancialAccountsResourceAchToggleSettings" (\obj -> ((GHC.Base.pure TreasuryFinancialAccountsResourceAchToggleSettings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "requested")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status_details"))}
-- | Create a new 'TreasuryFinancialAccountsResourceAchToggleSettings' with all required fields.
mkTreasuryFinancialAccountsResourceAchToggleSettings :: GHC.Types.Bool -- ^ 'treasuryFinancialAccountsResourceAchToggleSettingsRequested'
  -> TreasuryFinancialAccountsResourceAchToggleSettingsStatus' -- ^ 'treasuryFinancialAccountsResourceAchToggleSettingsStatus'
  -> [TreasuryFinancialAccountsResourceTogglesSettingStatusDetails] -- ^ 'treasuryFinancialAccountsResourceAchToggleSettingsStatusDetails'
  -> TreasuryFinancialAccountsResourceAchToggleSettings
mkTreasuryFinancialAccountsResourceAchToggleSettings treasuryFinancialAccountsResourceAchToggleSettingsRequested treasuryFinancialAccountsResourceAchToggleSettingsStatus treasuryFinancialAccountsResourceAchToggleSettingsStatusDetails = TreasuryFinancialAccountsResourceAchToggleSettings{treasuryFinancialAccountsResourceAchToggleSettingsRequested = treasuryFinancialAccountsResourceAchToggleSettingsRequested,
                                                                                                                                                                                                                                                                                               treasuryFinancialAccountsResourceAchToggleSettingsStatus = treasuryFinancialAccountsResourceAchToggleSettingsStatus,
...
data TreasuryFinancialAccountsResourceAchToggleSettingsStatus' =
   TreasuryFinancialAccountsResourceAchToggleSettingsStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TreasuryFinancialAccountsResourceAchToggleSettingsStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TreasuryFinancialAccountsResourceAchToggleSettingsStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | TreasuryFinancialAccountsResourceAchToggleSettingsStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  | TreasuryFinancialAccountsResourceAchToggleSettingsStatus'EnumRestricted -- ^ Represents the JSON value @"restricted"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryFinancialAccountsResourceAchToggleSettingsStatus'
    where {toJSON (TreasuryFinancialAccountsResourceAchToggleSettingsStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryFinancialAccountsResourceAchToggleSettingsStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> TreasuryFinancialAccountsResourceAchToggleSettingsStatus'EnumActive
