...
mkProduct :: GHC.Types.Bool -- ^ 'productActive'
  ...
  -> Product
mkProduct productActive productCreated productFeatures productId productImages productLivemode productMetadata productName productUpdated = Product{productActive = productActive,
