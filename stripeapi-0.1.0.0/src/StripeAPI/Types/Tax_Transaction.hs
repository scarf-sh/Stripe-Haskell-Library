...
mkTax'transaction :: GHC.Types.Int -- ^ 'tax'transactionCreated'
  ...
  -> Tax'transactionType' -- ^ 'tax'transactionType'
  -> Tax'transaction
mkTax'transaction tax'transactionCreated tax'transactionCurrency tax'transactionCustomerDetails tax'transactionId tax'transactionLivemode tax'transactionReference tax'transactionTaxDate tax'transactionType = Tax'transaction{tax'transactionCreated = tax'transactionCreated,
