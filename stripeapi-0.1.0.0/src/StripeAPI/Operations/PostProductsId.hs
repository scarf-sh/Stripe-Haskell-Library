...
data PostProductsIdRequestBodyFeatures'OneOf1 = PostProductsIdRequestBodyFeatures'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyFeatures'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyFeatures'OneOf1Name obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyFeatures'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsIdRequestBodyFeatures'OneOf1" (\obj -> GHC.Base.pure PostProductsIdRequestBodyFeatures'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name"))}
-- | Create a new 'PostProductsIdRequestBodyFeatures'OneOf1' with all required fields.
mkPostProductsIdRequestBodyFeatures'OneOf1 :: Data.Text.Internal.Text -- ^ 'postProductsIdRequestBodyFeatures'OneOf1Name'
...
data PostProductsIdRequestBodyFeatures'Variants =
   PostProductsIdRequestBodyFeatures'EmptyString -- ^ Represents the JSON value @""@
  | PostProductsIdRequestBodyFeatures'ListTPostProductsIdRequestBodyFeatures'OneOf1 ([PostProductsIdRequestBodyFeatures'OneOf1])
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyFeatures'Variants
    where {toJSON (PostProductsIdRequestBodyFeatures'ListTPostProductsIdRequestBodyFeatures'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyFeatures'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyFeatures'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyFeatures'EmptyString
