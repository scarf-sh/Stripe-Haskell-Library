...
postClimateReservationsOrder :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ order: Unique identifier of the order. | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostClimateReservationsOrderRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostClimateReservationsOrderResponse) -- ^ Monadic computation which returns the result of the operation
postClimateReservationsOrder order
                             body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostClimateReservationsOrderResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostClimateReservationsOrderResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       Climate'order)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostClimateReservationsOrderResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostClimateReservationsOrderRequestBody = PostClimateReservationsOrderRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateReservationsOrderRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateReservationsOrderRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostClimateReservationsOrderRequestBody" (\obj -> ((GHC.Base.pure PostClimateReservationsOrderRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "beneficiary")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata"))}
...
mkPostClimateReservationsOrderRequestBody = PostClimateReservationsOrderRequestBody{postClimateReservationsOrderRequestBodyBeneficiary = GHC.Maybe.Nothing,
...
data PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1 = PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["public_name" Data.Aeson.Types.ToJSON..= postClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1" (\obj -> GHC.Base.pure PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "public_name"))}
-- | Create a new 'PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1' with all required fields.
mkPostClimateReservationsOrderRequestBodyBeneficiary'OneOf1 :: PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Variants -- ^ 'postClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'
...
data PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Variants =
   PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString -- ^ Represents the JSON value @""@
  | PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Variants
    where {toJSON (PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1PublicName'EmptyString
...
data PostClimateReservationsOrderRequestBodyBeneficiary'Variants =
   PostClimateReservationsOrderRequestBodyBeneficiary'EmptyString -- ^ Represents the JSON value @""@
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostClimateReservationsOrderRequestBodyBeneficiary'Variants
    where {toJSON (PostClimateReservationsOrderRequestBodyBeneficiary'PostClimateReservationsOrderRequestBodyBeneficiary'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostClimateReservationsOrderRequestBodyBeneficiary'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostClimateReservationsOrderRequestBodyBeneficiary'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostClimateReservationsOrderRequestBodyBeneficiary'EmptyString
...
data PostClimateReservationsOrderResponse =
   PostClimateReservationsOrderResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostClimateReservationsOrderResponse200 Climate'order -- ^ Successful response.
  | PostClimateReservationsOrderResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
